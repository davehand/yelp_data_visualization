...
class MapGen:
	...
	# Generates a map using the following algorithm:
	#	1. Interpolate over all data points to create a color map that spans
	#		all of the points
	#	2. Interpolate over clustered data points to define a masking boundary
	#	3. Apply (2) over (1) and save the output as an image
